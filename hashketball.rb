...
def player_numbers(name)
  numbers = []
  if game_hash[:home][:team_name] == name
    game_hash[:home][:players].each do |key, player_name|
      numbers << player_name[:number]
    end
  else
    game_hash[:away][:players].each do |key, player_name|
      numbers << player_name[:number]
    end
  end
...
def big_shoe_rebounds
  ...
  game_hash.each do |location, values|
    values[:players].each do |player, data|
